...
<a href="https://render.com/deploy?repo=https://github.com/Pranav2612000/trigger.dev-test">
...
```sh
git clone https://github.com/Pranav2612000/trigger.dev-test.git
cd trigger.dev-test
npm install
```
...
The easiest way to fire off the `newStarEvent` is to go ahead and star the repo (in this case it's [this repo](https://github.com/Pranav2612000/trigger.dev-test)). Head back to the Workflow Overview page and you should see a run is in progress:
